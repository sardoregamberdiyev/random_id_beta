...
def btns(tip=None):
    ...
    if tip == "lang":
        ...
        bts = [
            ...
            [KeyboardButton("Bog'lanish 📲"), KeyboardButton("Orqaga🔙")],
        ]
    ...
    # ID olish
        ...
        context.bot.send_document(chat_id=chat_id, document=open("YordamPDF.pdf", "rb"), filename='YordamPDF.pdf',
                                  caption="<b>Unicard</b> loyihasi haqida va to'g'ri boshqarish sistemadan to'g'ri "
                                          "foydalani to'g'risida elektron tushuncha PDF.", parse_mode="HTML")
...
def main():
    updater = Updater("6268136991:AAHPWhzbVnzkd3X088Yen-hetQWdptfMt4U", use_context=True)
